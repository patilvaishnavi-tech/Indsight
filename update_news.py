...
print(f"\n✅ Saved — {total} stories")
# NOTE: git add/commit/push is handled by the GitHub Actions workflow step.
# Do NOT push here — the workflow's "Commit and push" step does it cleanly.
print(f"\n{'='*48}\n  Done! {total} stories. Workflow will commit & push.\n{'='*48}\n")
