...
Model: gemini-2.5-flash-lite — verified free, 1000 req/day, March 2026
"""
...
MODEL          = "gemini-2.5-flash-lite-preview-06-17"  # current free model
...
SECTIONS = [
  ...
  ("lead",      f"Business journalist {TODAY}. TOP 5 real auto leadership changes — CEO, CFO, MD, Board appointments. {NEWS_FORMAT}", {"Leadership":"#92400e","CEO":"#92400e","Board":"#92400e"}),
  ...
  ("tradenews", f"Trade analyst India {TODAY}. TOP 5 real import/export policy news — DGFT, FTA, anti-dumping. {NEWS_FORMAT}", {"Export":"#9a3412","Import":"#9a3412","FTA":"#9a3412","DGFT":"#155e75"}),
]
...
def render_card(s, i, total, tag_map):
    ...
    link  = (f'<a class="n-link" href="{url}" target="_blank" rel="noopener">Read Original ↗</a>'
...
def main():
    ...
    for cid, prompt, tag_map in SECTIONS:
        print(f"📰 [{cid}] Calling Gemini 2.5 Flash-Lite...")
