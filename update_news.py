...
MODEL = "gemini-2.0-flash"   # ✅ verified free model March 2026
...
NEWS_FORMAT = """
STRICT RULES:
1. Only REAL news from last 30 days — no fabricated events
2. Max 5 stories — each must cover a UNIQUE topic (no duplicates)
3. ONE tag per story from: EV | ICE | OEM | Battery | Policy | Charging | Commodity
4. Source must be ONLY from approved list in prompt — skip if not available
5. Summary: signal only, short lines, no deep explanation

Return ONLY valid JSON (no markdown):
{"stories":[{"tag":"EV","headline":"Real headline with company + verified number","summary":["Signal: what happened","Context: why","Number: exact figure","India impact","Watch: next step"],"source":"Exact approved publication name","url":"https://publication-homepage.com"}]}
Exactly 5 unique real stories. JSON only."""
